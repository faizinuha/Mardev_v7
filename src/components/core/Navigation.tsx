...
const Navigation = (props: Props) => {
    ...
    return (
        <nav style={{top: `${(top < 0 ? top-10 : top)}px`, transition: "top 0.25s"}} className={`z-[1000] w-full sticky top-0 h-auto flex items-center justify-center py-3 px-0 lg:px-20 bg-white bg-opacity-70 backdrop-blur-sm`}>
            <div className='flex justify-center group w-10/12 md:w-full'>
                <ul className='flex lg:gap-12 gap-4 border-2 border-secondary px-3 py-2 rounded-full group-hover:ring-1 group-hover:ring-secondary'>
